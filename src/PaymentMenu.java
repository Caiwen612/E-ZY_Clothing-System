...
public class PaymentMenu {
    ...
    public static void bank(Payment bank, Cart cart) throws InterruptedException {
    ...
    public static void eWallet(Payment eWallet, Cart cart) throws InterruptedException {
